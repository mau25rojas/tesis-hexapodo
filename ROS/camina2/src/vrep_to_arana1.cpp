...
//    FILE *fp;
//    fp = fopen("/home/maureen/fuerte_workspace/sandbox/TesisMaureen/ROS/camina2/pQ2.txt", "r");

    std::fstream myfile("/home/maureen/fuerte_workspace/sandbox/TesisMaureen/ROS/camina2/pQ4.txt", std::ios_base::in);
...
//        for(int k=0;k<18;k++) printf("%f,",q_archivo[k]);
//        printf("\n");
//        printf("\n");
//        getchar();
        for(int k=0;k<6;k++){
