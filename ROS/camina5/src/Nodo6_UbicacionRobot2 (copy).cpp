...
#include "camina5/TransTrayectoriaParametros.h"
// Used API services:
#include "vrep_common/VrepInfo.h"
#include "vrep_common/ObjectGroupData.h"
//-- Clientes y servicios
ros::ServiceClient client_Trans_MundoPata;
camina5::TransTrayectoriaParametros srv_Trans_MundoPata;
//-- Global variables:
...
//-- Topicos susbcritos y publicados
    ...
    ros::Publisher chatter_pub = node.advertise<camina5::UbicacionRobot>("UbicacionRobot", 100);
    client_Trans_MundoPata = node.serviceClient<camina5::TransTrayectoriaParametros>("TrayectoriaMundoPata");

    fp = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/Nodo6.txt","w+");
