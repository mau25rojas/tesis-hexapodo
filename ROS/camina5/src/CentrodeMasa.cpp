...
#include "/home/maureenr/fuerte_workspace/sandbox/TesisMaureen/ROS/Convexhull/vector3d.hpp"
#include "/home/maureenr/fuerte_workspace/sandbox/TesisMaureen/ROS/Convexhull/convexhull.cpp"
#include "/home/maureenr/fuerte_workspace/sandbox/TesisMaureen/ROS/Convexhull/analisis.cpp"
...
recta3d recta_ME[2];
camina5::UbicacionRobot cm_Robot;
BITMAP *buffer;
FILE *fp, *fp1;
int NPuntos_hull=0;
float ME=0.0;
...
void ubicacionCuerpoCallback(camina5::UbicacionRobot msgUbicacionCuerpo)
{
...
int main(int argc,char* argv[])
{
    ...
    chatter_pub = node.advertise<camina5::UbicacionRobot>("CentrodeMasa", 100);
    //Clientes y servicios
...
//    IniciaGrafica();
    ...
    fp = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/CM_ME.txt","w+");
    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/convexhull.txt","w+");
