...
#include "camina5/EspacioTrabajoParametros.h"
// Used API services:
...
camina5::EspacioTrabajoParametros srv_EspacioTrabajo;
...
void ajusteCallback(camina5::InfoMapa msgInfoMapa)
{
	for(int k=0; k<Npatas; k++){
...
//-- Topicos susbcritos y publicados
    ...
    chatter_pub = node.advertise<camina5::InfoMapa>("GraficaMapa", 100);
    //Clientes y Servicios
//    client_EspacioTrabajo=node.serviceClient<camina5::EspacioTrabajoParametros>("EspacioTrabajo");
...
//--- Inicializacion de archivo de salida
    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/SalidaMapa_robot.txt","w+");
    fp2 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/SalidaMapa_ajuste.txt","w+");
//--- Ciclo de ROS
//	periodo=1.5;
//    f=1/periodo;
