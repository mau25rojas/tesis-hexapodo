...
void datosCallback(const camina::DatosTrayectoriaPata msg_datoTrayectoria)
{
    ...
    float *ptr_x, *ptr_q;   //Apuntadores a arreglos de angulos y coordenadas
    ...
    if (0<=t_Trayectoria && t_Trayectoria<beta)
        {
            ...
            seleccionTramo=0;
            CalculoTrayectoria(ptr_x, landa, dh, velocidadApoyo, velocidadTransferencia, t_Tramo, seleccionTramo);
            ...
            CalculoCinInversa(ptr_q,coordenadasCartesianas[0],coordenadasCartesianas[1],coordenadasCartesianas[2]);
