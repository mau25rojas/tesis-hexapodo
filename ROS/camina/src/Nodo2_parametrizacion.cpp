...
//-- Clientes y Servicios
    ...
    client_TransHomogenea = node.serviceClient<camina::TransHomogeneaParametros>("TransHomogenea");
    ...
    std::string fileName2("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina/datos/SalidaQ");
    fileName2+=Id;
    fileName2+=texto;
