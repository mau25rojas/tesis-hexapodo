...
float margen_est (punto3d P, punto3d *hull, int k, recta3d *rectaSalida);				//Determina el margen de estabilidad del punto P, respecto al cascaron hull de k puntos:
