...
camina3::CinversaParametros srv_Cinversa1;
...
bool PlanificadorPisada(camina3::PlanificadorParametros::Request  &req,
                        camina3::PlanificadorParametros::Response &res)
{
...
//                ROS_INFO("TripodeOK");
            ...
            //-- Pisada maxima
                ...
                infoMapa.PataID[k] = Tripode_Apoyo[k];
            }
        } else {
...
//-- Topicos susbcritos y publicados
    chatter_pub1=node.advertise<camina3::SenalesCambios>("Senal", 100);
    chatter_pub2=node.advertise<camina3::InfoMapa>("Plan", 100);
...
//-- Clientes y Servicios
    ...
    client_Cinversa1=node.serviceClient<camina3::CinversaParametros>("Cinversa");

    /* Log de planificador */
    fp2 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina3/datos/LogPlanificador.txt","w+");
