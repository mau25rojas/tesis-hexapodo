...
#include "camina9/TransTrayectoriaParametros.h"
// Used API services:
...
camina9::TransTrayectoriaParametros srv_Trans_MundoPata;
//-- Global variables:
...
camina9::UbicacionRobot ubicacionRobot;
...
//-- Topicos susbcritos y publicados
    ...
    ros::Publisher chatter_pub = node.advertise<camina9::UbicacionRobot>("UbicacionRobot", 100);
    client_Trans_MundoPata = node.serviceClient<camina9::TransTrayectoriaParametros>("TrayectoriaMundoPata");

    fp = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_vel.txt","w+");
    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P1.txt","w+");
    fp2 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P2.txt","w+");
    fp3 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P3.txt","w+");
    fp4 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P4.txt","w+");
    fp5 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P5.txt","w+");
    fp6 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina9/datos/Nodo6_P6.txt","w+");
