...
void chatterCallback(const sensor_msgs::Joy msg)
{
  ...
  {
  	msg2.pata = 0; //selecciona la pata 0
  }
  if (msg.buttons[7] == true)
  {
  	msg2.pata = 1; //selecciona la pata 1
  }
  if (msg.buttons[8] == true)
  {
  	msg2.pata = 2; //selecciona la pata 2
  }
  if (msg.buttons[9] == true)
  {
  	msg2.pata = 3; //selecciona la pata 3
  }  
  if (msg.buttons[10] == true)
  {
  	msg2.pata = 4; //selecciona la pata 4
  }  
  if (msg.buttons[11] == true)
  {
  	msg2.pata = 5; //selecciona la pata 5
  }
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  chatter_pub = n.advertise<camina::pata>("arana/leg_position", 100);
