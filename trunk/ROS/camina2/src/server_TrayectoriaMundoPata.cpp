...
#include "camina2/TransTrayectoriaParametros.h"
// Used API services:
...
bool TrayectoriaMundoPata(camina2::TransTrayectoriaParametros::Request  &req,
                        camina2::TransTrayectoriaParametros::Response &res)
{
