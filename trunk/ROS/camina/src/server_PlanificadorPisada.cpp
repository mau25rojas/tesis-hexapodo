...
camina::CinversaParametros srv_Cinversa1;
...
bool PlanificadorPisada(camina::PlanificadorParametros::Request  &req,
                        camina::PlanificadorParametros::Response &res)
{
...
//-- Topicos susbcritos y publicados
    chatter_pub1=node.advertise<camina::SenalesCambios>("Senal", 100);
    chatter_pub2=node.advertise<camina::InfoMapa>("Plan", 100);
...
//-- Clientes y Servicios
    ...
    client_Cinversa1=node.serviceClient<camina::CinversaParametros>("Cinversa");
