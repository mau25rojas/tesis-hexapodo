...
void ubicacionCuerpoCallback(camina::UbicacionRobot msgUbicacionCuerpo)
{
...
//    IniciaGrafica();
    ...
    fp = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina/datos/CM_ME.txt","w+");
    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina/datos/convexhull.txt","w+");
