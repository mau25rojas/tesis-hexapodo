...
class InfoMapa(genpy.Message):
  _md5sum = "fa78deaf74f76d4412d8adebd19d390b"
...
"""
  __slots__ = ['nCeldas_i','nCeldas_j','iCelda','tamanoCelda_i','tamanoCelda_j','cantidadObstaculos','coordenadaObstaculo_i','coordenadaObstaculo_j','NPata','coordenadaPata_i','coordenadaPata_j','pataApoyo','correccion','coordenadaPreAjuste_i','coordenadaPreAjuste_j','coordenadaAjuste_i','coordenadaAjuste_j']
  _slot_types = ['uint8','uint8','uint8','float32','float32','uint8','uint8[]','uint8[]','uint8','uint8[]','uint8[]','uint8[]','bool','uint8[]','uint8[]','uint8[]','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       nCeldas_i,nCeldas_j,iCelda,tamanoCelda_i,tamanoCelda_j,cantidadObstaculos,coordenadaObstaculo_i,coordenadaObstaculo_j,NPata,coordenadaPata_i,coordenadaPata_j,pataApoyo,correccion,coordenadaPreAjuste_i,coordenadaPreAjuste_j,coordenadaAjuste_i,coordenadaAjuste_j
