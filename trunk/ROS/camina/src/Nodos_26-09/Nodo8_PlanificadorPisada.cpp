...
//    }
//    VelocidadApoyo=lambda_Apoyo/beta_arg;
...
//                        ROS_INFO("Nodo8: Posicion actual:[%d] i:%d\t j:%d",k+1,infoMapa.coordenadaAjuste_i[k],infoMapa.coordenadaAjuste_j[k]);
//                        chatter_pub1.publish(infoMapa);
//                      ROS_INFO("Bien:[%d] lambda_Transferencia:%.3f\n",k,datosTrayectoriaModificada.lambda_Transferencia[k]);
