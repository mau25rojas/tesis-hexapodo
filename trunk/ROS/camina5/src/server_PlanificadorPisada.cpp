...
#include "camina5/InfoMapa.h"
#include "camina5/CinversaParametros.h"
#include "camina5/UbicacionRobot.h"
...
camina5::CinversaParametros srv_Cinversa1;
...
camina5::SenalesCambios senales;
//-- Generales
//int k=0;
...
void ubicacionRobCallback(camina5::UbicacionRobot msgUbicacionRobot)
{
    float vel_aux=0.0;
...
//-- la velocidad no puede ser mayor a la esperada
    ...
    for(int k=0; k<Npatas;k++) {
        ...
        posicionActualPata_j[k] = msgUbicacionRobot.coordenadaPata_j[k];

    }
}

bool PlanificadorPisada(camina5::PlanificadorParametros::Request  &req,
                        camina5::PlanificadorParametros::Response &res)
{
...
//                ROS_INFO("TripodeOK");
            ...
            //-- Pisada maxima
                ...
                infoMapa.coordenadaPreAjuste_i[Tripode_Apoyo[k]] = posicionActualPata_i[Tripode_Apoyo[k]];
                infoMapa.coordenadaPreAjuste_j[Tripode_Apoyo[k]] = posicionActualPata_j[Tripode_Apoyo[k]];
            }
        } else {
...
//-- Topicos susbcritos y publicados
    chatter_pub1=node.advertise<camina5::SenalesCambios>("Senal", 100);
    chatter_pub2=node.advertise<camina5::InfoMapa>("Plan", 100);
...
//-- Clientes y Servicios
    ...
    client_Cinversa1=node.serviceClient<camina5::CinversaParametros>("Cinversa");

    /* Log de planificador */
    fp2 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/LogPlanificador.txt","w+");
