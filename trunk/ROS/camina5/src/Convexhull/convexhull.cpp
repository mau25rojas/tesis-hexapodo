...
float margen_est (punto3d P, punto3d *arreglo, int k, recta3d *rectaSalida)
{
...
//   	register int i;
        ...
        for (i=0; i<k; i++)
        {
            ...
            if ((r.distancia(P))<margen) {
                margen = r.distancia(P);  //Verifico si la nueva distancia minima es menor a las anteriores
                rectaSalida[0]=r;
            }
        }
        delete hull;
