...
#include "camina5/AngulosMotor.h"
#include "camina5/CinversaParametros.h"
#include "camina5/TransHomogeneaParametros.h"
// Used API services:
...
camina5::CinversaParametros srv_Cinversa;
ros::ServiceClient client_TransHomogenea;
camina5::TransHomogeneaParametros srv_TransHomogenea;
...
*/
void datosCallback(const camina5::DatosTrayectoriaPata msg_datoTrayectoria)
{
...
//-- Topicos susbcritos y publicados
    chatter_pub = node.advertise<camina5::AngulosMotor>("DatosDeMotores", 100);
...
//-- Clientes y Servicios
    client_Cinversa = node.serviceClient<camina5::CinversaParametros>("Cinversa");
    client_TransHomogenea = node.serviceClient<camina5::TransHomogeneaParametros>("TransHomogenea");

    std::string fileName("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/SalidaX");
    std::string texto(".txt");
    fileName+=Id;
    fileName+=texto;
    fp1 = fopen(fileName.c_str(),"w+");

    std::string fileName2("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina5/datos/SalidaQ");
    fileName2+=Id;
    fileName2+=texto;
