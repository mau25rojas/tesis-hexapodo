...
#include "camina3/TrayectoriaEliptica1Parametros.h"
// Used API services:
...
bool TrayectoriaEliptica1(camina3::TrayectoriaEliptica1Parametros::Request  &req,
                        camina3::TrayectoriaEliptica1Parametros::Response &res)
{
