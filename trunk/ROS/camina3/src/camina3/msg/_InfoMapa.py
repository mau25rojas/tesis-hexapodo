"""autogenerated by genpy from camina3/InfoMapa.msg. Do not edit."""
import sys
...
class InfoMapa(genpy.Message):
  _md5sum = "125b85cf4888662bccfe6791ceea6b4d"
  _type = "camina3/InfoMapa"
...
"""
  __slots__ = ['nCeldas_i','nCeldas_j','iCelda','tamanoCelda_i','tamanoCelda_j','cantidadObstaculos','coordenadaObstaculo_i','coordenadaObstaculo_j','NPata','coordenadaPata_i','coordenadaPata_j','pataApoyo','correccion','coordenadaPreAjuste_i','coordenadaPreAjuste_j','coordenadaAjuste_i','coordenadaAjuste_j','PataID']
  _slot_types = ['uint8','uint8','uint8','float32','float32','uint8','uint8[]','uint8[]','uint8','uint8[]','uint8[]','uint8[]','bool','uint8[]','uint8[]','uint8[]','uint8[]','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       nCeldas_i,nCeldas_j,iCelda,tamanoCelda_i,tamanoCelda_j,cantidadObstaculos,coordenadaObstaculo_i,coordenadaObstaculo_j,NPata,coordenadaPata_i,coordenadaPata_j,pataApoyo,correccion,coordenadaPreAjuste_i,coordenadaPreAjuste_j,coordenadaAjuste_i,coordenadaAjuste_j,PataID
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.correccion))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.correccion,) = _struct_B.unpack(str[start:end])
      self.correccion = bool(self.correccion)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.PataID = str[start:end].decode('utf-8')
      else:
        self.PataID = str[start:end]
      return self
