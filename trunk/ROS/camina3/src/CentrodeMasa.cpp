...
recta3d recta_ME[2];
camina3::UbicacionRobot cm_Robot;
BITMAP *buffer;
FILE *fp, *fp1;
int NPuntos_hull=0;
float ME=0.0;
...
void ubicacionCuerpoCallback(camina3::UbicacionRobot msgUbicacionCuerpo)
{
...
//	}
    ...
    chatter_pub = node.advertise<camina3::UbicacionRobot>("CentrodeMasa", 100);
    //Clientes y servicios
...
//    IniciaGrafica();
    ...
    fp = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina3/datos/CM_ME.txt","w+");
    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina3/datos/convexhull.txt","w+");
