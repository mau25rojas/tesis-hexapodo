...
//    ros::Subscriber subInfo2=node.subscribe("UbicacionRobot",100,ubicacionRobCallback);
    ...
    chatter_pub = node.advertise<camina12::InfoMapa>("GraficaMapa", 100);
...
//    fp1 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina12/datos/Errores.txt","a+");
    fp2 = fopen("../fuerte_workspace/sandbox/TesisMaureen/ROS/camina12/datos/SalidaMapa_ajuste.txt","w+");
