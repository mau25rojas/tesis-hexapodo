...
camina11::UbicacionRobot cm_Robot;
BITMAP *buffer;
FILE *fp, *fp1;
...
void ubicacionCuerpoCallback(camina11::UbicacionRobot msgUbicacionCuerpo)
{
...
//        fprintf("%d\t",cuentaPataApoyo);
    ...
    //-- Calculo de margen de estabilidad longitudinal
        ...
        segmento3d segmento_ME; punto3d proyeccion;
...
int main(int argc,char* argv[])
{
    ...
    chatter_pub = node.advertise<camina11::UbicacionRobot>("CentrodeMasa", 100);
    //Clientes y servicios
